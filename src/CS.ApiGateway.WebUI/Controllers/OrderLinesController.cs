...
namespace CS.ApiGateway.WebUI.Controllers
{
    public class OrderLinesController : Controller
    {
        ...
        {
            var cSApiGatewayWebUIContext2 = _context.OrderLine.Include(o => o.Order);
        ...
        public async Task<IActionResult> Create([Bind("Id,LineNumber,OrderId,Product,Quantity,Amount")] OrderLine orderLine)
        {
            ...
            ViewData["OrderId"] = new SelectList(_context.Order, "Id", "Code", orderLine.OrderId);
            return View(orderLine);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LineNumber,OrderId,Product,Quantity,Amount")] OrderLine orderLine)
        {
            if (id != orderLine.Id)
            {
                return NotFound();
